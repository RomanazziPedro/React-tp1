...
import POKE_IMG from '../../assets/images/poke.jpeg'
                ...
                <Dialog
                    ...
                    open={open}>
                        <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
                            {data?data.name:'_'} <Avatar sx={{ width: 100, height: 100 }} src={data.sprites.front_default}>M</Avatar>
                        </BootstrapDialogTitle>
                        <DialogContent dividers>
                        <Accordion sx={{width:'50mv'}}>
                            <AccordionSummary
